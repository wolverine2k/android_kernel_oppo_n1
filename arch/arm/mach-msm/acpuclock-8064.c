...
/*
 * The correct maximum rate for 8064ab is 600 MHZ.
...
static struct msm_bus_paths bw_level_tbl[] __initdata = {
	...
	[6] = BW_MBPS(5064), /* At least 633 MHz on bus. */
};
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {   162000, HFPLL, 0, 0x06 }, L2(0),   825000 },
	...
	{ 1, {  1674000, HFPLL, 1, 0x40 }, L2(17), 1175000 },
	//{ 1, {  1728000, HFPLL, 1, 0x42 }, L2(17), 1200000 },
	{ 1, {  1782000, HFPLL, 1, 0x44 }, L2(17), 1200000 },
	//{ 1, {  1836000, HFPLL, 1, 0x46 }, L2(17), 1200000 },
	{ 0, { 0 } }
};
